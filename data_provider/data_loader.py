...
class Dataset_sodra(Dataset):
    def __init__(self, root_path, flag='train', size=None, features='MS',
                 data_path='dataset-sodra.xlsx', target=" ",
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_excel(os.path.join(self.root_path,
                                          self.data_path), sheet_name="Data 10 min averages")
...
class Dataset_sodra2(Dataset):
    def __init__(self, root_path, flag='train', size=None, features='MS',
                 data_path='dataset-sodra2.xlsx', target='',
                 scale=True, timeenc=0, freq='h'):
        # size [seq_len, label_len, pred_len]
        # info
        self.seq_len = size[0]
